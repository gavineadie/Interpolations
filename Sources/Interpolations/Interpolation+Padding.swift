...
public class StringFormatter {
    ...
    public var alignment: TextAlignment = .right      // The direction that aligns the text
    public var paddingCharacter: Character = " "      // The character used to pad the text
    public var width: Int = 0                         // The minimum width of the resulting string
    ...
    func string(from string: StringLiteralType) -> StringLiteralType {
        ...
        switch alignment {
            case .right:            // Left pad "abc" to width 5 with " " -> "  abc"
                return padding(corePadCount) + string
            case .left:             // Right pad "abc" to width 5 with " " -> "abc  "
                return string + padding(corePadCount)
            case .center:           // Center pad "abc" to width 5 with " " -> " abc "
